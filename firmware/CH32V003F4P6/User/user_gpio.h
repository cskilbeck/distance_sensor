...
inline void GPIO_Setup(GPIO_TypeDef *gpio, int pin, u32 config)
{
    pin *= 4;
    gpio->CFGLR = (gpio->CFGLR & ~(0xf << pin)) | (config << pin);
}

//////////////////////////////////////////////////////////////////////

inline void GPIO_SetupPins(GPIO_TypeDef *GPIOx, u32 pins, u32 config)
{
    u32 mask = 0;
    u32 cfg = 0;
