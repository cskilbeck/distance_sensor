...
inline void GPIO_Setup(GPIO_TypeDef *gpio, int pin_number, uint32 config)
{
    pin_number *= 4;
...
inline void GPIO_SetupPins(GPIO_TypeDef *GPIOx, uint32 pin_mask, uint32 config)
{
    uint32 mask = 0;
    uint32 cfg = 0;
...
inline void GPIO_SetPullup(GPIO_TypeDef *GPIOx, uint32 mask)
{
    GPIOx->BSHR = mask;
}
...
inline void GPIO_SetPullDown(GPIO_TypeDef *GPIOx, uint32 mask)
{
    GPIOx->BSHR = mask << 16;
}
...
inline void GPIO_Set(GPIO_TypeDef *GPIOx, uint32 mask)
{
    GPIOx->BSHR = mask;
}
...
inline int GPIO_Get(GPIO_TypeDef *GPIOx, uint32 mask)
{
...
inline void GPIO_Clear(GPIO_TypeDef *GPIOx, uint32 mask)
{
    GPIOx->BCR = mask;
}
...
inline void GPIO_SetAndClear(GPIO_TypeDef *GPIOx, uint32 mask_on, uint32 mask_off)
{
...
inline void GPIO_Toggle(GPIO_TypeDef *GPIOx, uint32 mask)
{
    GPIOx->OUTDR ^= mask;
}
...
inline void GPIO_SetTo(GPIO_TypeDef *GPIOx, uint32 mask, int on_or_off)
{
